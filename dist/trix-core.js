...
(function() {
  ...
  Trix.ToolbarController = (function(superClass) {
    ...
    ToolbarController.prototype.getDialog = function(dialogName) {
      return this.element.querySelector(".dialog[data-dialog=" + dialogName + "]");
    };
    ...
    getDialogName = function(element) {
      return element.getAttribute("data-dialog");
    };
...
(function() {
  ...
  Trix.HTMLParser = (function(superClass) {
    var allowedAttributes, blockForAttributes, convertNewlinesToSpaces, elementCanDisplayNewlines, getAttachmentAttributes, getBlockElementMargin, getImageDimensions, nodeFilter, pieceForAttachment, pieceForString, removeInsignificantWhitespace, sanitizeHTML;
    ...
    HTMLParser.prototype.processTextNode = function(node) {
      ...
      if (string = normalizeSpaces(node.data)) {
        if (!elementCanDisplayNewlines(node.parentNode)) {
    ...
    HTMLParser.prototype.getTextAttributes = function(element) {
      ...
      for (attribute in ref) {
        ...
        if (config.tagName && tagName(element) === config.tagName) {
    ...
    convertNewlinesToSpaces = function(string) {
      return string.replace(/\s?\n\s?/g, " ");
    };

    elementCanDisplayNewlines = function(element) {
      var whiteSpace;
...
(function() {
  ...
  Trix.Composition = (function(superClass) {
    ...
    Composition.prototype.setBlockAttribute = function(attributeName, value) {
      var ref, selectedRange;
      if ((ref = this.getBlock()) != null ? ref.getConfig("leaf") : void 0) {
